...
static const unsigned char yyrline[] =
{
     ...
     120,   121,   129,   130,   133,   152,   153,   156,   157,   166,
     169,   172,   173,   180,   192
};
#endif
...
#line 134 "aig_g.yy"
  ...
  d8_printf4("symbol %c %d = %s\n",*(yyvsp[-2].id),index,aig_string_buffer);
  aig_string_index = 0;
...
#line 174 "aig_g.yy"
    {  
  strncat(aig_string_buffer, (yyvsp[0].id), aig_string_index<1000?1000-aig_string_index:0);
  aig_string_index += strlen((yyvsp[0].id));
